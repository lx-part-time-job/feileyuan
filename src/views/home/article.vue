...
<template>
    <div class="content container-fluid">
        ...
        <div class="article part">
            <h3 class="article-title">玩游戏那么久，还不知道RE引擎？</h3>
            <div class="article-infos ov">
                <span class="article-info fl icon-news">新闻资讯</span>
                <span class="article-info fl icon-author">文文 发表于2019-1-2 18:21</span>
                <span class="article-info fl icon-watch">阅读数2019</span>
                <span class="article-info fl icon-comment">评论数2019</span>
            </div>
        ...
        <div class="related part">
            ...
            <div class="related-links">
                <a href="#" class="related-link ellipsis">在菲生活不要忘了提升自己：一起来玩个小游戏吧 在菲工作评论医保的重要性！就医花费巨款和免费的区别！ 作为河南人的一声叹息，但我</a>
                <a href="#" class="related-link ellipsis">在菲生活不要忘了提升自己：一起来玩个小游戏吧 在菲工作评论医保的重要性！就医花费巨款和免费的区别！ 作为河南人的一声叹息，但我</a>
                <a href="#" class="related-link ellipsis">在菲生活不要忘了提升自己：一起来玩个小游戏吧 在菲工作评论医保的重要性！就医花费巨款和免费的区别！ 作为河南人的一声叹息，但我</a>
                <a href="#" class="related-link ellipsis">在菲生活不要忘了提升自己：一起来玩个小游戏吧 在菲工作评论医保的重要性！就医花费巨款和免费的区别！ 作为河南人的一声叹息，但我</a>
            </div>
            ...
            <div class="list">
                <div>
                    <div class="list-content ov">
                        ...
                        <div class="fl">
                            <div class="ov">
                                <span class="fl list-name">这是一个用户ID</span>
                                <span class="fl list-date">发表于2019-1-2 11:12</span>
                            </div>
                            <div class="list-detail">我很赞同你的想法～</div>
                        </div>
                    </div>
